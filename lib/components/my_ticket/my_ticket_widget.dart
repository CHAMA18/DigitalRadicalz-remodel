                ...
                final groups = grouped.entries.toList()
                  ..sort((a, b) {
                    ...
                    for (final t in a.value) {
                      if (latestA == null ||
                          (t.purchaseDate != null && t.purchaseDate!.isAfter(latestA!))) {
                    ...
                    for (final t in b.value) {
                      if (latestB == null ||
                          (t.purchaseDate != null && t.purchaseDate!.isAfter(latestB!))) {
                ...
                return Column(
                  ...
                  children: [
                    if (allTickets.isEmpty)
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0, 48.0, 0, 0),
                        child: Text(
                          'No tickets yet',
                          ...
                          onPressed: () async {
                            ...
                            try {
                              final qs = await FirebaseFirestore.instance
                                  ...
                                  .get();
                              const batchSize = 400;
                              for (var i = 0; i < qs.docs.length; i += batchSize) {
                              ...
                              if (mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('All tickets deleted.')),
                                );
                              }
                            } catch (e) {
                              if (mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Failed to delete tickets: $e')),
                                );
                              }
                            }
                          },
                            ...
                            return Dismissible(
                              ...
                              confirmDismiss: (direction) async {
                                return await showDialog<bool>(
                                      context: context,
                                      builder: (ctx) => AlertDialog(
                                        title: const Text('Delete one ticket?'),
                                        content: Text(qty > 1
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          valueOrDefault<String>(
                                                            dateTimeFormat("M/d h:mm a", rowEventsRecord.date),
                                                            '19/02/2023   18.30.00-20.00',
                                                          ),
                                                          style: FlutterFlowTheme.of(context)
                                                              .bodyMedium
                                                              .override(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Padding(
                                                          padding: const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 0.0),
                                                          child: Text(
                                                            (rowEventsRecord.address).isNotEmpty
                                                                ? rowEventsRecord.address
                                                                : 'Club Twenty3, Melkweg 1, 1079 CX, Amsterdam',
                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                  font: GoogleFonts.inter(
                                                                    fontWeight: FontWeight.normal,
