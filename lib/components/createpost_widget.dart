              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  if (selectedMedia != null &&
                    ...
                    safeSetState(
                        () => _model.isDataUploading_uploadDataVl91 = true);
                    ...
                    try {
                      ...
                      _model.isDataUploading_uploadDataVl91 = false;
                    }
                    if (selectedUploadedFiles.length == selectedMedia.length &&
                        downloadUrls.length == selectedMedia.length) {
                      safeSetState(() {
                        _model.uploadedLocalFile_uploadDataVl91 =
                            selectedUploadedFiles.first;
                        _model.uploadedFileUrl_uploadDataVl91 =
                            downloadUrls.first;
                      });
                    } else {
                      safeSetState(() {});
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await PostRecord.collection.doc().set(createPostRecordData(
                        communityid: widget!.communityref,
                        image: _model.uploadedFileUrl_uploadDataVl91,
                        comumunityname: _model.textController1.text,
