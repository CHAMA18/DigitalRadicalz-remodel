...
import 'angenda2_model.dart';
export 'angenda2_model.dart';

class Angenda2Widget extends StatefulWidget {
  const Angenda2Widget({super.key});

  @override
  State<Angenda2Widget> createState() => _Angenda2WidgetState();
}

class _Angenda2WidgetState extends State<Angenda2Widget>
    with TickerProviderStateMixin {
  late Angenda2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Angenda2Model());
