...
class DetailCopyWidget extends StatefulWidget {
  ...
  final DocumentReference? tickettyperef;
        ...
        child: Column(
          ...
          children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder<TicketTypesRecord>(
                            stream: TicketTypesRecord.getDocument(
                                widget!.tickettyperef!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                              ...
                              final columnTicketTypesRecord = snapshot.data!;
                              ...
                              StreamBuilder<List<TicketTypesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<TicketTypesRecord>
                                      textTicketTypesRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  }
                                  final textTicketTypesRecord =
                                      textTicketTypesRecordList.isNotEmpty
                                          ? textTicketTypesRecordList.first
                                          : null;

                                  return Text(
                                    valueOrDefault<String>(
                                      formatNumber(
                                        textTicketTypesRecord?.price,
                                        formatType: FormatType.decimal,
            ...
            Column(
              ...
              children: [
                StreamBuilder<TicketTypesRecord>(
                  stream: TicketTypesRecord.getDocument(widget!.tickettyperef!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                    ...
                    final richTextTicketTypesRecord = snapshot.data!;
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: valueOrDefault<String>(
                              formatNumber(
                                richTextTicketTypesRecord.totalPrice,
                                formatType: FormatType.decimal,
                                decimalType: DecimalType.periodDecimal,
                                currency: '€',
                              ),
                      ...
                      onPressed: () async {
                        await TicketsRecord.collection
                            ...
                            .set(createTicketsRecordData(
                              ...
                              ticketTypeId: widget!.tickettyperef,
                              status: 'notpaid',
