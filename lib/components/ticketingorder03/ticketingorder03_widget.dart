...
import '/index.dart';
import 'ticketingorder03_model.dart';
export 'ticketingorder03_model.dart';

class Ticketingorder03Widget extends StatefulWidget {
  const Ticketingorder03Widget({super.key});

  @override
  State<Ticketingorder03Widget> createState() => _Ticketingorder03WidgetState();
}

class _Ticketingorder03WidgetState extends State<Ticketingorder03Widget> {
  late Ticketingorder03Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Ticketingorder03Model());
