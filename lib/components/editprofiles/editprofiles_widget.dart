            ...
            InkWell(
              ...
              onTap: () async {
                ...
                if (selectedMedia != null &&
                  ...
                  safeSetState(() =>
                      _model.isDataUploading_uploadDataI74 = true);
                  ...
                  if (selectedUploadedFiles.length == selectedMedia.length) {
                    safeSetState(() {
                      _model.uploadedLocalFile_uploadDataI74 =
                          selectedUploadedFiles.first;
                    });

                    // Upload the selected image to Firebase Storage and update user photoUrl
                    try {
                      // Debug logs
                      print('[EditProfile] Selected storagePath: '
                          '${selectedMedia.first.storagePath}');
                      print('[EditProfile] Bytes length: '
                      ...
                      // Build a user-scoped storage path that aligns with Firebase Storage rules
                      final originalPath = selectedMedia.first.storagePath;
                      final ext = originalPath.contains('.') ? '.${originalPath.split('.').last}' : '.jpg';
                      final safePath = 'users/$currentUserUid/profile_${DateTime.now().millisecondsSinceEpoch}$ext';
                      print('[EditProfile] Uploading to: $safePath');
                      String? downloadUrl;
                      try {
                        ...
                        print('[EditProfile] Firebase Storage error: code=${fe.code}, message=${fe.message}, path=$safePath');
                        rethrow;
                      }
                      if (mounted) {
                        ScaffoldMessenger.of(context).hideCurrentSnackBar();
                      }
                      print('[EditProfile] Download URL: $downloadUrl');
                      if (downloadUrl != null) {
                        // Update Firestore user document with new photo URL
                        await currentUserReference!.update(
                          createUsersRecordData(photoUrl: downloadUrl),
                        );
                        print('[EditProfile] Firestore user photoUrl updated');

                        // Also update FirebaseAuth profile photo for consistency
                        try {
                          await FirebaseAuth.instance.currentUser
                              ?.updatePhotoURL(downloadUrl);
                          print('[EditProfile] Auth photoURL updated');
                        } catch (e) {
                          print('[EditProfile] Auth photoURL update failed: $e');
                        }

                        // Evict old and new images from cache so the UI shows the latest photo immediately
                        try {
                        ...
                        // Trigger a UI refresh after upload completes
                        safeSetState(() {});
                      ...
                      // Avoid using context if the widget is disposed
              ...
              child: Row(
                ...
                children: [
                  AuthUserStreamWidget(
                    builder: (context) {
                      // Prefer the freshly selected local preview if available,
                      // otherwise show the user photo (which will auto-rebuild via AuthUserStreamWidget)
                      final hasLocal = _model
                                  .uploadedLocalFile_uploadDataI74.bytes !=
                              null &&
                          _model.uploadedLocalFile_uploadDataI74.bytes!
                              .isNotEmpty;
                      final photo = currentUserPhoto;
                      return Container(
                        key: ValueKey(hasLocal ? 'local' : photo),
                        width: 100.0,
                        height: 100.0,
                        decoration: BoxDecoration(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        validator: _model.passwordchangeTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Example@Digitalradicalz.com',
                          hintStyle:
                              FlutterFlowTheme.of(context).labelMedium.override(
                                    font: GoogleFonts.inter(
                                      fontWeight: FlutterFlowTheme.of(context)
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        validator: _model.emailchangeTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            width: 100.0,
                            child: TextFormField(
                              controller: _model.streetchangeTextController,
                      ...
                      Padding(
                        ...
                        child: Container(
                          width: 100.0,
                          child: TextFormField(
                            controller: _model.numberstreetTextController,
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        validator: _model.phonnumberTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await currentUserReference!.update(createUsersRecordData(
                    ...
                    addressname: _model.streetchangeTextController.text,
                    addressnumber: _model.numberstreetTextController.text,
