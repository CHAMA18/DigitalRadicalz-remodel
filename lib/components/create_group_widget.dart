              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  if (selectedMedia != null &&
                    ...
                    safeSetState(
                        () => _model.isDataUploading_uploadDataVl9 = true);
                    ...
                    try {
                      ...
                      _model.isDataUploading_uploadDataVl9 = false;
                    }
                    if (selectedUploadedFiles.length == selectedMedia.length &&
                        downloadUrls.length == selectedMedia.length) {
                      safeSetState(() {
                        _model.uploadedLocalFile_uploadDataVl9 =
                            selectedUploadedFiles.first;
                        _model.uploadedFileUrl_uploadDataVl9 =
                            downloadUrls.first;
                      });
                    } else {
                      safeSetState(() {});
                ...
                onPressed: () async {
                  await GroupsRecord.collection
                      ...
                      .set(createGroupsRecordData(
                        ...
                        groupimage: _model.uploadedFileUrl_uploadDataVl9,
                        groupDescription: _model.textController2.text,
                      ));
