...
import 'communityposts_model.dart';
export 'communityposts_model.dart';

class CommunitypostsWidget extends StatefulWidget {
  const CommunitypostsWidget({
    super.key,
    required this.communiyref,
  });

  final DocumentReference? communiyref;

  static String routeName = 'Communityposts';
  static String routePath = '/communityposts';
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<CommunitiesRecord>(
                      stream:
                          CommunitiesRecord.getDocument(widget!.communiyref!),
                          ...
                          children: [
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    text: rowCommunitiesRecord.name,
                    ...
                    child: StreamBuilder<List<PostRecord>>(
                      stream: queryPostRecord(
                        queryBuilder: (postRecord) => postRecord
                            .where(
                              'communityid',
                              isEqualTo: widget!.communiyref,
                            )
                            .orderBy('dateofapload', descending: true),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              columnPostRecord.comumunityname,
