...
for (final group in groupChatSnapshot.data!) {
...
isSelected: FFAppState().chatTab == 'Berichten',
),
],
),
),
...
isSelected: FFAppState().chatTab == 'Groeps chat',
),
],
),
),
...
Text(
TimestampFormatter.formatChatListPreview(
...
// Handle error state (including permission denied)
if (snapshot.hasError) {
debugPrint('Communities query error: ${snapshot.error}');
return Center(
child: Padding(
padding: EdgeInsets.all(24.0),
child: Column(
