...
import 'community_ui_model.dart';
export 'community_ui_model.dart';

class CommunityUiWidget extends StatefulWidget {
  const CommunityUiWidget({super.key});

  static String routeName = 'CommunityUi';
  static String routePath = '/communityUi';

  @override
  State<CommunityUiWidget> createState() => _CommunityUiWidgetState();
}

class _CommunityUiWidgetState extends State<CommunityUiWidget> {
  late CommunityUiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommunityUiModel());
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      fit: BoxFit.cover,
                                      image: Image.asset(
                                        'assets/images/54bc2dae62b356f13ec564abc6ddc69257afe4d7.jpg',
                                      ).image,
                                    ),
