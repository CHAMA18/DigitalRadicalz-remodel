...
class VideoWidget extends StatefulWidget {
  const VideoWidget({
    super.key,
    required this.videonewsref,
  });

  final DocumentReference? videonewsref;
...
class _VideoWidgetState extends State<VideoWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<NewsRecord>(
      stream: NewsRecord.getDocument(widget!.videonewsref!),
      builder: (context, snapshot) {
        ...
        final videoNewsRecord = snapshot.data!;
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                await videoNewsRecord.reference.update({
                                  ...mapToFirestore(
                                    {
                    ...
                    StreamBuilder<List<NewsRecord>>(
                      stream: queryNewsRecord(
                        queryBuilder: (newsRecord) => newsRecord
                            .where(
                              'category',
                              isEqualTo: videoNewsRecord.category,
                            )
